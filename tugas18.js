function Tugas18() {
    var no1 = "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.".slice(8,24);
    ...
    var no2 = string1.concat(" ",string2)
